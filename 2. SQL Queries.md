...
Since 99.48% of users in the transactions table are not present in the users table, imputing age data to maintain the distribution shown in the chart below.
